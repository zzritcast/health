...
public class POITest  {
    ...
    public void test() throws Exception{
        XSSFWorkbook excel = new XSSFWorkbook(new FileInputStream(new File("D:\\health\\poi.xlsx")));
        //或群excel文件中的第个sheet页
    ...
    public void test3()throws Exception{
        ...
        FileOutputStream out = new FileOutputStream(new File("D:\\health\\hello.xlsx"));
        excel.write(out);
        out.flush();
        excel.close();
