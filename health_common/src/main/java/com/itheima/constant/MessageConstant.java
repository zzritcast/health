...
public class MessageConstant {
    ...
    public static final String DELETE_SETMEAL_FALL = "删除套餐失败";
    public static final String DELETE_SETMEAL_SUCCESS ="删除套餐成功" ;
    public static final String ORDER_TO_FALL = "日期转换失败";

    public static final String EDIT_SETMEAL_FALL = "修改套餐失败";
    public static final String UPLOAD_FALL = "EXCEL_导入失败";
    public static final String ORDER_DATE_ERROR = "查询预约日期不合法";
    public static final String ORDER_CANCEL_SUCCESS = "预约取消成功";
    public static final String ORDER_CANCEL_FAIL = "预约取消失败";
    public static final String ORDER_EDIT_SUCCESS = "确诊成功";
    public static final String ORDER_EDIT_FAIL = "确诊失败";
    public static final String EDIT_USER_ROLE_SUCCESS = "修改用户角色成功";
    public static final String EDIT_USER_ROLE_FALL = "修改用户角色失败";
    public static final String EDIT_PERMISSION_SUCCESS = "角色修改权限成功";
    public static final String EDIT_PERMISSION_FAIL = "角色修改权限失败";
    public static final String QUERY_ADDRESS_SUCCESS = "地址查询成功";
    public static final String QUERY_ADDRESS_FAIL = "地址查询失败";
    public static final String SITE_DELETE_FAIL = "地址删除失败";
    public static final String SITE_DELETE_SUCCESS = "地址删除成功";
    public static final String SITE_SAVE_SUCCESS = "地址添加成功";
    public static final String SITE_SAVE_FAIL = "地址保存失败";

    public static final String GET_PERMISSION_SUCESS ="获取权限数据成功";
    public static final String GET_PERMISSION_FALL ="获取权限数据失败";

    public static final String ADD_ROLE_SUCCESS = "添加角色成功";
    public static final String ADD_ROLE_FALL = "添加角色失败";
